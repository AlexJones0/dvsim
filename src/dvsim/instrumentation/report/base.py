...
def render_large_figure(
    ...
    *,
    ...
    """Render a (maybe) large plotly figure depending upon its size compared to some threshold.
    ...
    # For now, to keep this abstraction simple, encode the image as a b64 png. TODO: it might
    # be nice to render this image as a separate report artifact in the future.
    return (
...
def make_job_metadata_hover(
    ...
    *,
    ...
    Args:
        job_id: The ID / full name of the job (displayed as the tooltip title).
